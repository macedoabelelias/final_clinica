...
$url_arquivo = $url_sistema."painel/img/marketing/".$arquivo;
...
$url_audio = $url_sistema."painel/img/marketing/".$audio;
...
$pdo->query("UPDATE marketing SET envios = '$envios', data_envio = curDate(), hash = '$hash', hash2 = '$hash2', hash3 = '$hash3', forma_envio = '$pacientes' where id = '$id'");
