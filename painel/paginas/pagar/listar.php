...
echo <<<HTML
			<tr> 
				...
				<td>
					<big><a class="{$ocultar}" href="#" onclick="editar('{$id}', '{$descricao}', '{$cliente}','{$valor}','{$data_venc}','{$frequencia}','{$saida}','{$arquivo}', '{$obs}','{$data_pgto}')" title="Editar Dados"><i class="fa fa-edit text-primary "></i></a></big>
